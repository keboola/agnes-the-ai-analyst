...
def test_schema_version_is_at_least_42():
...
def test_v42_indices_exist(tmp_path):
    ...
    # v94 dropped: idx_usage_session_user, idx_usage_session_started,
    # idx_usage_session_user_id (index-corruption hotfix — see
    # test_db_schema_version.py::test_v94_fresh_install_has_no_usage_session_summary_secondary_indexes).
    for idx in [
    ...
    for idx in [
        ...
        assert idx not in idx_names, f"index {idx} should have been dropped in v94"
    conn.close()
