...
class TestMarketplaceInfo:
    ...
    def test_user_with_no_groups_returns_empty(self, marketplace_env):
        """v14: no implicit Everyone — a user with no memberships gets an
        empty plugin list and an empty groups list, but the call still
        succeeds (200, not 401/403)."""
        c = marketplace_env["client"]
