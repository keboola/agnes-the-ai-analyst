...
_GRANDFATHERED_DIRECT_INSTANTIATION: dict[str, set[str]] = {
    ...
    "app/api/cowork_bundle.py": {"AccessTokenRepository", "AuditRepository", "SetupTokenRepository", "UserRepository"},
    ...
    "app/api/mcp_user_secrets.py": {"MCPSourceRepository"},
    ...
    "app/api/stack.py": {"UsageRepository"},
    ...
    "app/web/router.py": {"SyncStateRepository", "TableRegistryRepository"},
