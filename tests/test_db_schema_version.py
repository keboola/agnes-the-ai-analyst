...
def test_schema_version_is_28():
    ...
    # initial_load_chunk_days). Existing sync_strategy column reused; admins
    # can opt specific tables back to query_mode='local' for the new
    # dispatcher (incremental, partitioned, full_refresh + where_filters).
