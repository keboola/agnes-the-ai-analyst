...
def test_schema_version_is_46():
    ...
    # v44 → v45: usage_session_summary + usage_events gain user_id column
    #            for stable RBAC filtering. USAGE_PROCESSOR_VERSION bumps
    #            so the reprocess loop backfills.
    # v45 → v46 (this PR): marketplace telemetry refactor. Drops 4 legacy
