      ...
      VStack(alignment: .leading, spacing: 16) {
        ...
        VStack(alignment: .leading, spacing: 7) {
          Label("CLI gaps", systemImage: "point.3.connected.trianglepath.dotted")
            ...
            .foregroundStyle(AgnesTheme.text)
          Link("#1344 · runnable agent discovery", destination: URL(string: "https://github.com/keboola/agnes-the-ai-analyst/issues/1344")!)
          Link("#1345 · machine-readable sessions", destination: URL(string: "https://github.com/keboola/agnes-the-ai-analyst/issues/1345")!)
        }
        .font(.caption)
      }
      .padding(16)
