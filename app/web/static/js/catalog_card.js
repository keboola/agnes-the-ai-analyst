...
(function () {
  ...
  const KIND_GLYPH = {
    ...
    app: '<svg viewBox="0 0 24 24" fill="none" aria-hidden="true"><rect x="3.5" y="4.5" width="17" height="15" rx="2" stroke="currentColor" stroke-width="1.7"/><path d="M3.5 9.5h17" stroke="currentColor" stroke-width="1.7"/><circle cx="6.6" cy="7" r="0.9" fill="currentColor"/><circle cx="9.4" cy="7" r="0.9" fill="currentColor"/></svg>',
  };
  const META_GLYPH = {
