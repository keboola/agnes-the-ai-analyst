...
def _init_lines(server_url_placeholder: str = "{server_url}") -> list[str]:
    ...
    return [
        ...
        "   Run `agnes update` instead (same token file): it safely converges the",
        "   CLI, workspace, plugins and data and repairs anything broken WITHOUT",
        "   wiping your edits — any changed managed file is backed up to `.bak`.",
        "   Then skip to step 4.",
        "",
