...
def _swap_live_to_version(entity_id: str, version_no: int) -> bool:
    ...
    Three-step swap so a failed copy doesn't leave the live dir half-
    populated: rename live → backup, copytree version → live, rmtree
    backup. On copytree failure: restore from backup. Returns ``True``
    on success.
    """
