...
the workspace folder (`workspace.name.lower()`).  When the IWT ships a
...
folder name lowercased.  If your IWT installs the workspace into a folder
called `MyTeamAI`, the launcher must be `workspace/bin/myteamai` (plus
