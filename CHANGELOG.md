...
### Internal
- Google group prefix sync test now accepts both `302` and `307` redirect codes — Starlette/FastAPI changed the default from 302 to 307; both are semantically equivalent for GET. (#676)
