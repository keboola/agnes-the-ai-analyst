...
module "agnes" {
  ...
  #
  # Adding a stage / perf VM later = create matching SM secrets and append a
  # dev_instances entry with role = "stage" (overriding the default "dev").
  # No change to this main.tf needed.
