"""SQLAlchemy model for ``jobs`` (v92) — durable job queue.

Mirrors the DuckDB DDL in ``src/db.py`` (``_v91_to_v92`` / ``_SYSTEM_SCHEMA``)
and the Alembic migration ``migrations/versions/0039_jobs_v92.py``. This is
