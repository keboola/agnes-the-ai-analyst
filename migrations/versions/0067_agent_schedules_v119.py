"""agent_schedules — scheduled runs for agent profiles (DuckDB v119).

Mirrors DuckDB's ``_v118_to_v119`` / ``_SYSTEM_SCHEMA`` addition. Design doc:
...
Revision ID: 0067_agent_schedules_v119
...
revision: str = "0067_agent_schedules_v119"
