"""Skill lint (store guardrails) — store_lint_runs/findings/dismissals/entity_state (DuckDB v91).

Revision ID: 0038_store_lint_v91
Revises: 0037_chat_broker_tickets_v90
"""

import sqlalchemy as sa
from alembic import op

revision: str = "0038_store_lint_v91"
down_revision: str = "0037_chat_broker_tickets_v90"
branch_labels = None
depends_on = None
