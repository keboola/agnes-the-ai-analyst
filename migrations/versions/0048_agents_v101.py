"""agent profiles + agent-as-API foundation (DuckDB v101).

Revision ID: 0048_agents_v101
Revises: 0046_data_apps_drafts_v99

Mirrors DuckDB's ``_v100_to_v101`` / ``_SYSTEM_SCHEMA`` additions (spec
